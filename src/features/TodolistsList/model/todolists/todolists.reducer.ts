import { createSlice, isAnyOf, isRejectedWithValue, PayloadAction } from "@reduxjs/toolkit";
...
const slice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    // .addMatcher(isRejectedWithValue(todolistsThunks.removeTodolist), (state, action) => {
    //   debugger;
    //
    //   // const todo = state.find((todo) => todo.id === action.payload.id);
    //   // if (todo) {
